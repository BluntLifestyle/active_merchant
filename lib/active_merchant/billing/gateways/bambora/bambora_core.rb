module ActiveMerchant #:nodoc:
  module Billing #:nodoc:
    module BamboraCore
      ...
      RECURRING_URL = 'https://www.bambora.com/scripts/recurring_billing.asp'
      SECURE_PROFILE_URL = 'https://www.bambora.com/scripts/payment_profile.asp'
