...
module ActiveMerchant #:nodoc:
  module Billing #:nodoc:
    class BamboraInteracResponse < Response
      def redirect
        params['pageContents']
      end
    end

    class BamboraInteracGateway < Gateway
      include BamboraCore

      # Confirm a transaction posted back from the bank to Bambora.
      ...
      def build_response(*args)
        BamboraInteracResponse.new(*args)
      end
    end
  end
end
